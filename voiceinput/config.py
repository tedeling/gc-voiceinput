...
class Config:
    ...
    def load(cls, argv: list[str] | None = None) -> "Config":
        ...
        parser.add_argument("--hotkey", default=None, help="evdev key name (default: KEY_F4)")
        parser.add_argument("--tmux-target", default=None, help="tmux pane target (default: auto-detect)")
        ...
        cfg = cls()
        for fname in ("hotkey", "tmux_target", "model_size", "silence_threshold", "sample_rate", "device_path", "backend", "groq_api_key"):
